...
/// Since TruePokemonSDK is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    ...
    fatalError("unable to find bundle named TruePokemon_TruePokemonSDK")
}()
}
